...
for s=1:NScans
    ...
    % bbm added for conveniently reading the header info of the real scan.
    twix_obj{s}.ScanFidStartPos=cPos;

    % declare data objects:
    twix_obj{s}.image         = twix_map_objVE(arg,'image',filename,version,rstraj);
    twix_obj{s}.noise         = twix_map_objVE(arg,'noise',filename,version);
    twix_obj{s}.phasecor      = twix_map_objVE(arg,'phasecor',filename,version,rstraj);
    twix_obj{s}.phasestab     = twix_map_objVE(arg,'phasestab',filename,version,rstraj);
    twix_obj{s}.phasestabRef0 = twix_map_objVE(arg,'phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.phasestabRef1 = twix_map_objVE(arg,'phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.refscan       = twix_map_objVE(arg,'refscan',filename,version,rstraj);
    twix_obj{s}.refscanPC     = twix_map_objVE(arg,'refscan_phasecor',filename,version,rstraj);
    twix_obj{s}.refscanPS     = twix_map_objVE(arg,'refscan_phasestab',filename,version,rstraj);
    twix_obj{s}.refscanPSRef0 = twix_map_objVE(arg,'refscan_phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.refscanPSRef1 = twix_map_objVE(arg,'refscan_phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.RTfeedback    = twix_map_objVE(arg,'rtfeedback',filename,version,rstraj);
    twix_obj{s}.vop           = twix_map_objVE(arg,'vop',filename,version); % tx-array rf pulses
