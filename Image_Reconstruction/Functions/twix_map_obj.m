...
%
    ...
    methods
        ...
        function this = readMDH(this,mdh,filePos)
            ...
            if cAcq > this.currentAlloc
                ...
                this.memPos       = cat(2, this.memPos      , zeros(1,this.allocSize));
            end
        ...
        function varargout = subsref(this, S)
            ...
            if ( isempty(S(1).subs) || strcmpi(S(1).subs(1),'') )
                ...
                for k=1:numel(S(1).subs)
                    ...
                    elseif isnumeric(S(1).subs{k})
                        selRange{cDim} = single(S(1).subs{k});
                    else
            ...
            cIxToTarg = sub2ind(selRangeSz(3:end),cIx(1,:),cIx(2,:),cIx(3,:),...
            ...
            for k=1:numel(mem)
                ...
                if bRemoveOS
                    ...
                    raw         = ifft(raw);
                    ival        = size(raw,1)/4+1:size(raw,1)*3/4;
                    raw(ival,:) = [];
                    raw         = fft(raw);
                end
    ...
    methods (Access='protected')
        ...
        function checkRange(this,selRange)
            for k=1:numel(selRange)
        ...
        function calcIndices(this)
            ...
            this.ixToTarget = sub2ind(this.fullSize(3:end),...
            ...
            this.ixToRaw = zeros(1,prod(this.fullSize(3:end)),'single');
