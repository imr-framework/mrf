  function psino = rebin_fan2par_helix(fsino, sf, sp, varargin)
%|function psino = rebin_fan2par_helix(fsino, sf, sp, varargin)
%|
...
%|	'beta_interp'	default: {'order', 3, 'ending', 'zero' or 'periodic'}
%|	'helical'		1 for helical, 0 for axial
%|
%| out
...
%|
%| helical case contributed by Donghwan Kim 2014-11-10
%|
...
if arg.helical
	arg.beta_interp = {'order', 3, 'ending', 'mirror'}; % DK
end
